...
\begin{center}
{
    ...
    \vspace{\stretch{0.5}}
	  ...
	  \vspace{\stretch{12}}
 		...
 		\huge{\bf Sviluppo prototipale di una soluzione survivable per autenticatori hardware FIDO }}\\
		\vspace{3mm}\
...
\input{sections/conoscenze}
\input{sections/modellazione}
\input{sections/dettagli}
\input{sections/prestazioni}
